...
const Header = () => {
  ...
  const onSubmit = handleSubmit((data: FormData) => {
    navigate({
      ...
      search: createSearchParams({ name: data.name }).toString()
    })
  })
      ...
      <div className='container'>
        <div className='flex justify-end'>
          ...
          >
            ...
            <span className='mx-1 mb-1 capitalize'>english</span>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              fill='none'
              viewBox='0 0 24 24'
        ...
        <div className='mt-4 grid grid-cols-12 items-end gap-4'>
          <Link to={pagePath.home} className='col-span-2'>
            <svg viewBox='0 0 192 65' className='h-8 w-full fill-white lg:h-11'>
              <g fillRule='evenodd'>
          ...
          <form className='col-span-9' onSubmit={onSubmit} noValidate>
            <InputSpacer className='flex rounded-sm bg-white p-1'>
              <Input
                type='text'
